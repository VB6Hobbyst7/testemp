...
{
    public partial class Graphic_Elements_Demo : UserControl
    {
        private void createPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\PDF_Creator\Graphic_Elements.pdf";
            try
            {
