...
namespace EvoHtmlToPdfDemo.PDF_Creator.Headers_and_Footers
{
    public partial class Page_Numbers_in_HTML_Description : UserControl
    {
        ...
        private void Page_Numbers_in_HTML_Description_Load(object sender, EventArgs e)
        {
            ...
            string descriptionString = System.IO.File.ReadAllText(@"DemoAppFiles\Input\Descriptions\WinForms\PDF_Creator\Headers_and_Footers\Page_Numbers_in_HTML.html");
