...
namespace EvoHtmlToPdfDemo.PDF_Creator.Headers_and_Footers
{
    public partial class Page_Numbers_in_HTML_Sample_Code : UserControl
    {
        ...
        private void Page_Numbers_in_HTML_Sample_Code_Load(object sender, EventArgs e)
        {
            ...
            string codeSampleString = System.IO.File.ReadAllText(@"DemoAppFiles\Input\Code_Samples\CSharp\WinForms\PDF_Creator\Headers_and_Footers\Page_Numbers_in_HTML.html");
