...
namespace EvoHtmlToPdfDemo.PDF_Creator.Headers_and_Footers
{
    public partial class Header_Footer_Auto_Resize_Sample_Code : UserControl
    {
        ...
        private void Header_Footer_Auto_Resize_Sample_Code_Load(object sender, EventArgs e)
        {
            ...
            string codeSampleString = System.IO.File.ReadAllText(@"DemoAppFiles\Input\Code_Samples\CSharp\WinForms\PDF_Creator\Headers_and_Footers\Header_Footer_Auto_Resize.html");
