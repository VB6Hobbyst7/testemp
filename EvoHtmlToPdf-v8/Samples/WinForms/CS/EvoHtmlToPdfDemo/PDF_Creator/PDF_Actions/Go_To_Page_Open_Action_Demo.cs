...
{
    public partial class Go_To_Page_Open_Action_Demo : UserControl
    {
        private void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\PDF_Creator\Go_To_Page_Open_Action.pdf";
            try
            {
        ...
        private void Go_To_Page_Open_Action_Demo_Load(object sender, EventArgs e)
        {
        ...
        public Go_To_Page_Open_Action_Demo()
        {
            InitializeComponent();
        }
    }
