...
{
    public partial class Image_Elements_Demo : UserControl
    {
        private void createPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\PDF_Creator\Image_Elements.pdf";
            try
            {
                ...
                string imagePath = @"DemoAppFiles\Input\Images\picture_small.jpg";
