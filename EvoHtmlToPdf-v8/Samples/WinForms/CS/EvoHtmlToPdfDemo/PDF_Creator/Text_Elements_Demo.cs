...
{
    public partial class Text_Elements_Demo : UserControl
    {
        private void createPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\PDF_Creator\Text_Elements.pdf";
            try
            {
                ...
                PdfFont localOpenTypeTrueTypeFont = pdfDocument.AddFont(@"DemoAppFiles\Input\Fonts\OpenTypeTrueType.otf");
                ...
                PdfFont localOpenTypePostScriptFont = pdfDocument.AddFont(@"DemoAppFiles\Input\Fonts\OpenTypePostScript.otf");
                ...
                string text = System.IO.File.ReadAllText(@"DemoAppFiles\Input\Text_Files\Text_File.txt");
                ...
                // Add the text element
                string multiPageText = System.IO.File.ReadAllText(@"DemoAppFiles\Input\Text_Files\Large_Text_File.txt");
