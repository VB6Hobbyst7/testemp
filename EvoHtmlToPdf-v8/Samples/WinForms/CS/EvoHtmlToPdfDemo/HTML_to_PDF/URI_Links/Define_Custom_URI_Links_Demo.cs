...
{
    public partial class Define_Custom_URI_Links_Demo : UserControl
    {
        private void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\HTML_to_PDF\Custom_URI_Links.pdf";
            try
            {
        ...
        private void Define_Custom_URI_Links_Demo_Load(object sender, EventArgs e)
        {
            htmlStringTextBox.Text = System.IO.File.ReadAllText(@"DemoAppFiles\Input\HTML_Files\Custom_URI_Links.html");
            baseUrlTextBox.Text = "file:///" + Application.StartupPath + @"\DemoAppFiles\Input\HTML_Files/";

            urlTextBox.Text = Application.StartupPath + @"\DemoAppFiles\Input\HTML_Files\Custom_URI_Links.html";
        }
        ...
        public Define_Custom_URI_Links_Demo()
        {
            InitializeComponent();
        }
    }
