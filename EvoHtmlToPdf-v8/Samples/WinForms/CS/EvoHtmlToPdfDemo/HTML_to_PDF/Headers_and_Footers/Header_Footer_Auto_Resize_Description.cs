...
namespace EvoHtmlToPdfDemo.HTML_to_PDF.Headers_and_Footers
{
    public partial class Header_Footer_Auto_Resize_Description : UserControl
    {
        ...
        private void Header_Footer_Auto_Resize_Description_Load(object sender, EventArgs e)
        {
            ...
            string descriptionString = System.IO.File.ReadAllText(@"DemoAppFiles\Input\Descriptions\WinForms\HTML_to_PDF\Headers_and_Footers\Header_Footer_Auto_Resize.html");
