...
namespace EvoHtmlToPdfDemo.HTML_to_PDF.Headers_and_Footers
{
    public partial class HTML_in_Header_Footer_Description : UserControl
    {
        ...
        private void HTML_in_Header_Footer_Description_Load(object sender, EventArgs e)
        {
            ...
            string descriptionString = System.IO.File.ReadAllText(@"DemoAppFiles\Input\Descriptions\WinForms\HTML_to_PDF\Headers_and_Footers\HTML_in_Header_Footer.html");
