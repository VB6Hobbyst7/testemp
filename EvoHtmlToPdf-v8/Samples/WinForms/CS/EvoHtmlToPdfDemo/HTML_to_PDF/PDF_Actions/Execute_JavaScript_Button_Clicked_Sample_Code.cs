...
namespace EvoHtmlToPdfDemo.HTML_to_PDF.PDF_Actions
{
    public partial class Execute_JavaScript_Button_Clicked_Sample_Code : UserControl
    {
        ...
        private void Execute_JavaScript_Button_Clicked_Sample_Code_Load(object sender, EventArgs e)
        {
            ...
            string codeSampleString = System.IO.File.ReadAllText(@"DemoAppFiles\Input\Code_Samples\CSharp\WinForms\HTML_to_PDF\PDF_Actions\Execute_JavaScript_Button.html");
