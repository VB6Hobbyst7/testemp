...
{
    public partial class HTML_Content_Scaling_Demo : UserControl
    {
        private void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\HTML_to_PDF\HTML_Content_Scaling.pdf";
            try
            {                
        ...
        public HTML_Content_Scaling_Demo()
        {
            InitializeComponent();
        }

        private void HTML_Content_Scaling_Load(object sender, EventArgs e)
        {
        ...
        private void fitWidthCheckBox_CheckedChanged(object sender, EventArgs e)
        {
