...
{
    public partial class Images_Scaling_and_JPEG_Compression_Demo : UserControl
    {
        private void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\HTML_to_PDF\Images_Scaling_and_JPEG_Compression.pdf";
            try
            {
        ...
        public Images_Scaling_and_JPEG_Compression_Demo()
        {
            InitializeComponent();
        }
    }
