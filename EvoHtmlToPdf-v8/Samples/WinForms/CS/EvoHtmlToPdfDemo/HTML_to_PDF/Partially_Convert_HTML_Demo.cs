...
{
    public partial class Partially_Convert_HTML_Demo : UserControl
    {
        private void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\HTML_to_PDF\Partially_Convert_HTML.pdf";
            try
            {
        ...
        public Partially_Convert_HTML_Demo()
        {
            InitializeComponent();
        }
    }
