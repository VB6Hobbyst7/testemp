...
{
    public partial class Insert_PDF_Pages_Before_Table_of_Contents_Demo : UserControl
    {
        private void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\HTML_to_PDF\Insert_PDF_Before_Table_of_Contents.pdf";
            try
            {
        ...
        private void Insert_PDF_Pages_Before_Table_of_Contents_Demo_Load(object sender, EventArgs e)
        {
        ...
        public Insert_PDF_Pages_Before_Table_of_Contents_Demo()
        {
            InitializeComponent();
        }
    }
