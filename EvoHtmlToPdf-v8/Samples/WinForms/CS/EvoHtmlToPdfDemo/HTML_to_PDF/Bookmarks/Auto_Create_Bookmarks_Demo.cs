...
{
    public partial class Auto_Create_Bookmarks_Demo : UserControl
    {
        private void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\HTML_to_PDF\Auto_Create_Hierarchical_Bookmarks.pdf";
            try
            {
        ...
        public Auto_Create_Bookmarks_Demo()
        {
            InitializeComponent();
        }
    }
