...
{
    public partial class Select_in_HTML_Elements_to_Bookmark_Demo : UserControl
    {
        private void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\HTML_to_PDF\Select_in_HTML_Elements_to_Bookmark.pdf";
            try
            {
        ...
        private void Select_in_HTML_Elements_to_Bookmark_Demo_Load(object sender, EventArgs e)
        {
        ...
        public Select_in_HTML_Elements_to_Bookmark_Demo()
        {
            InitializeComponent();
        }
    }
