...
{
    public partial class Select_in_API_Elements_to_Retrieve_Demo : UserControl
    {
        private void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\HTML_to_PDF\Select_in_API_HTML_Elements_to_Retrieve.pdf";
        ...
        public Select_in_API_Elements_to_Retrieve_Demo()
        {
            InitializeComponent();
        }
    }
