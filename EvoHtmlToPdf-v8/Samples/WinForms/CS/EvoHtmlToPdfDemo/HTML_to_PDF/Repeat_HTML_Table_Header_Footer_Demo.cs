...
{
    public partial class Repeat_HTML_Table_Header_Footer_Demo : UserControl
    {
        private void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\HTML_to_PDF\Repeat_HTML_Table_Header_Footer.pdf";
            try
            {
        ...
        private void Repeat_HTML_Table_Header_Footer_Demo_Load(object sender, EventArgs e)
        {
            htmlStringTextBox.Text = System.IO.File.ReadAllText(@"DemoAppFiles\Input\HTML_Files\Repeat_HTML_Header_Footer.html");
            baseUrlTextBox.Text = "file:///" + Application.StartupPath + @"\DemoAppFiles\Input\HTML_Files/";

            urlTextBox.Text = System.IO.Path.Combine(Application.StartupPath, @"DemoAppFiles\Input\HTML_Files\Repeat_HTML_Header_Footer.html");
        }
        ...
        public Repeat_HTML_Table_Header_Footer_Demo()
        {
            InitializeComponent();
        }
    }
