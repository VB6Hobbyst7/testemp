...
{
    public partial class Select_Screen_or_Print_Media_Type_Demo : UserControl
    {
        private void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\HTML_to_PDF\Select_Screen_or_Print_Media_Type.pdf";
            try
            {
        ...
        private void Select_Screen_or_Print_Media_Type_Demo_Load(object sender, EventArgs e)
        {
        ...
        public Select_Screen_or_Print_Media_Type_Demo()
        {
            InitializeComponent();
        }
    }
