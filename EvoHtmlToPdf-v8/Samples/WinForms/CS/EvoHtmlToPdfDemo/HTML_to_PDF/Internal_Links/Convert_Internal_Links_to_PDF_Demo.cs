...
{
    public partial class Convert_Internal_Links_to_PDF_Demo : UserControl
    {
        private void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\HTML_to_PDF\Convert_Internal_Links_to_PDF.pdf";
            try
            {
        ...
        public Convert_Internal_Links_to_PDF_Demo()
        {
            InitializeComponent();
        }
    }
