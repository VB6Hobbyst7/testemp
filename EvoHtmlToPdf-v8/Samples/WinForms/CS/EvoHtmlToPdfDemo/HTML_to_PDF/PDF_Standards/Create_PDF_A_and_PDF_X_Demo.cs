...
{
    public partial class Create_PDF_A_and_PDF_X_Demo : UserControl
    {
        private void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\HTML_to_PDF\PDF_A_PDF_X.pdf";
            try
            {
        ...
        public Create_PDF_A_and_PDF_X_Demo()
        {
            InitializeComponent();
        }
    }
