...
{
    public partial class Define_in_HTML_PDF_Form_Fields_Demo : UserControl
    {
        private void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\HTML_to_PDF\Define_in_HTML_PDF_Form_Fields.pdf";
            try
            {
        ...
        private void Define_in_HTML_PDF_Form_Fields_Demo_Load(object sender, EventArgs e)
        {
            string htmlForm = System.IO.File.ReadAllText(@"DemoAppFiles\Input\HTML_Files\Select_HTML_Form_Fields.html");
        ...
        public Define_in_HTML_PDF_Form_Fields_Demo()
        {
            InitializeComponent();
        }
    }
