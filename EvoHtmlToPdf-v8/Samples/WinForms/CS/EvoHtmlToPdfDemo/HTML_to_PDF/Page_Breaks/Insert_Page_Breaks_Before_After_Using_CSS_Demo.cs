...
{
    public partial class Insert_Page_Breaks_Before_After_Using_CSS_Demo : UserControl
    {
        private void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\HTML_to_PDF\Insert_Page_Breaks_Before_After_HTML_Elements_Using_CSS.pdf";
            try
            {
        ...
        private void Insert_Page_Breaks_Before_After_Demo_Load(object sender, EventArgs e)
        {
            htmlStringTextBox.Text = System.IO.File.ReadAllText(@"DemoAppFiles\Input\HTML_Files\Page_Break_Before_and_After_Using_CSS.html");
            baseUrlTextBox.Text = "file:///" + Application.StartupPath + @"\DemoAppFiles\Input\HTML_Files/";

            urlTextBox.Text = System.IO.Path.Combine(Application.StartupPath, @"DemoAppFiles\Input\HTML_Files\Page_Break_Before_and_After_Using_CSS.html");
        }
        ...
        public Insert_Page_Breaks_Before_After_Using_CSS_Demo()
        {
            InitializeComponent();
        }
    }
