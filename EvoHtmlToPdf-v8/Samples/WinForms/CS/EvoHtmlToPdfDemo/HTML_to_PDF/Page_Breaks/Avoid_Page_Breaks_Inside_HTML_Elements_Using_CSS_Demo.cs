...
{
    public partial class Avoid_Page_Breaks_Inside_HTML_Elements_Using_CSS_Demo : UserControl
    {
        private void convertToPdfButton_Click(object sender, EventArgs e)
        {
            ...
            string outPdfFile = @"DemoAppFiles\Output\HTML_to_PDF\Avoid_Page_Breaks_Inside_HTML_Elements_Using_CSS.pdf";
            try
            {
        ...
        private void Avoid_Page_Breaks_Inside_HTML_Elements_Demo_Load(object sender, EventArgs e)
        {
        ...
        public Avoid_Page_Breaks_Inside_HTML_Elements_Using_CSS_Demo()
        {
            InitializeComponent();
        }
    }
