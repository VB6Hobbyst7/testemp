Namespace EvoHtmlToPdfDemo.PDF_Creator
	Partial Public Class File_Links_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(File_Links_Demo))
...
'			Me.createPdfButton.Click += New System.EventHandler(Me.createPdfButton_Click)
			...
			Me.titleLabel.Text = "Add File Links in a PDF Document"
			' 
			' File_Links_Demo
			' 
