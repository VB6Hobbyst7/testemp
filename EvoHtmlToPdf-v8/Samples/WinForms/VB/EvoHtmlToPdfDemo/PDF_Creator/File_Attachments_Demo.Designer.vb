Namespace EvoHtmlToPdfDemo.PDF_Creator
	Partial Public Class File_Attachments_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(File_Attachments_Demo))
			...
			Me.demoRightPanel.TabIndex = 170
			' 
			' demoBottomPanel
			' 
			...
			Me.demoBottomPanel.TabIndex = 169
			' 
			' demoTopPanel
			' 
			...
			Me.convertButtonPanel.TabIndex = 186
			' 
			' createPdfButton
			' 
...
'			Me.createPdfButton.Click += New System.EventHandler(Me.createPdfButton_Click)
			...
			Me.titleLabel.Size = New Size(334, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Attach Files and Streams to a PDF Document"
			' 
