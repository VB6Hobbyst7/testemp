Namespace EvoHtmlToPdfDemo.PDF_Creator
	Partial Public Class URI_Links_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(URI_Links_Demo))
			...
			Me.convertButtonPanel.TabIndex = 177
			' 
			' createPdfButton
			' 
...
'			Me.createPdfButton.Click += New System.EventHandler(Me.createPdfButton_Click)
			...
			Me.descriptionPanel.TabIndex = 176
			' 
			' descriptionLabel
			' 
			...
			Me.titleLabel.Size = New Size(254, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Add URI Links in a PDF Document"
			' 
			' URI_Links_Demo
			' 
