...
Namespace EvoHtmlToPdfDemo.PDF_Creator.PDF_Actions
	Partial Public Class Execute_JavaScript_Button_Clicked_Description
		...
		Private Sub Execute_JavaScript_Button_Clicked_Description_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
			...
			Dim descriptionString As String = System.IO.File.ReadAllText("DemoAppFiles\Input\Descriptions\WinForms\PDF_Creator\PDF_Actions\Execute_JavaScript_Button.html")
