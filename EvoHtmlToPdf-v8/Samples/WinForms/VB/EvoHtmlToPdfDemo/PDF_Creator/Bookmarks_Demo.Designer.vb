Namespace EvoHtmlToPdfDemo.PDF_Creator
	Partial Public Class Bookmarks_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Bookmarks_Demo))
...
'			Me.createPdfButton.Click += New System.EventHandler(Me.createPdfButton_Click)
			...
			Me.titleLabel.Size = New Size(265, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Add Bookmarks to a PDF Document"
			' 
			' Bookmarks_Demo
			' 
