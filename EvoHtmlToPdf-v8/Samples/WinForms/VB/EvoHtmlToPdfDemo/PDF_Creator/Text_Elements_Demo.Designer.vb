Namespace EvoHtmlToPdfDemo.PDF_Creator
	Partial Public Class Text_Elements_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Text_Elements_Demo))
			...
			Me.convertButtonPanel.TabIndex = 171
			' 
			' createPdfButton
			' 
...
'			Me.createPdfButton.Click += New System.EventHandler(Me.createPdfButton_Click)
			...
			Me.titleLabel.Size = New Size(288, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Add Text Elements to a PDF Document"
			' 
			' Text_Elements_Demo
			' 
