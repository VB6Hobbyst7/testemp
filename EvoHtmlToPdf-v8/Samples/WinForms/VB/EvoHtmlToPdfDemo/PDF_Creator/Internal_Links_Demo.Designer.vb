Namespace EvoHtmlToPdfDemo.PDF_Creator
	Partial Public Class Internal_Links_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Internal_Links_Demo))
...
'			Me.createPdfButton.Click += New System.EventHandler(Me.createPdfButton_Click)
			...
			Me.titleLabel.Size = New Size(283, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Add Internal Links in a PDF Document"
			' 
			' Internal_Links_Demo
			' 
