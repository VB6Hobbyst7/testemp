Namespace EvoHtmlToPdfDemo.PDF_Creator
	Partial Public Class Graphic_Elements_Demo
		''' <summary> 
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Graphic_Elements_Demo))
			...
			Me.convertButtonPanel.TabIndex = 174
			' 
			' createPdfButton
			' 
...
'			Me.createPdfButton.Click += New System.EventHandler(Me.createPdfButton_Click)
			...
			Me.descriptionPanel.TabIndex = 173
			' 
			' descriptionLabel
			' 
			...
			Me.titleLabel.Text = "Add Graphic Elements to a PDF Document"
			' 
			' Graphic_Elements_Demo
			' 
