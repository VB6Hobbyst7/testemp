Namespace EvoHtmlToPdfDemo.PDF_Creator
	Partial Public Class Text_Notes_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Text_Notes_Demo))
			...
			Me.demoRightPanel.TabIndex = 174
			' 
			' demoBottomPanel
			' 
			...
			Me.demoBottomPanel.TabIndex = 173
			' 
			' demoTopPanel
			' 
...
'			Me.createPdfButton.Click += New System.EventHandler(Me.createPdfButton_Click)
			...
			Me.descriptionPanel.TabIndex = 188
			' 
			' descriptionLabel
			' 
			...
			Me.titleLabel.Size = New Size(264, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Add Text Notes to a PDF Document"
			' 
			' Text_Notes_Demo
			' 
