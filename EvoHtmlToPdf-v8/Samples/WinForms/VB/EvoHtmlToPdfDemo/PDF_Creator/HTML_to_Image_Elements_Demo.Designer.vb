Namespace EvoHtmlToPdfDemo.PDF_Creator
	Partial Public Class HTML_to_Image_Elements_Demo
		''' <summary> 
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(HTML_to_Image_Elements_Demo))
			...
			Me.convertButtonPanel.Location = New Point(6, 314)
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			Me.settingsPanel.Location = New Point(6, 177)
			...
			Me.Name = "HTML_to_Image_Elements_Demo"
