Namespace EvoHtmlToPdfDemo.HTML_to_PDF.URI_Links
	Partial Public Class Define_Custom_URI_Links_Demo
		''' <summary> 
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Define_Custom_URI_Links_Demo))
			...
			Me.demoLeftPanel.Size = New Size(6, 695)
			...
			Me.demoRightPanel.Size = New Size(6, 695)
			Me.demoRightPanel.TabIndex = 144
			' 
			' demoBottomPanel
			' 
			Me.demoBottomPanel.Dock = DockStyle.Bottom
			Me.demoBottomPanel.Location = New Point(0, 701)
			...
			Me.convertButtonPanel.Location = New Point(6, 656)
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			Me.htmlPanel.Location = New Point(6, 245)
			Me.htmlPanel.Name = "htmlPanel"
			Me.htmlPanel.Size = New Size(598, 411)
			Me.htmlPanel.TabIndex = 152
			' 
			' label2
			' 
			...
			Me.label12.Size = New Size(264, 15)
			Me.label12.TabIndex = 42
			Me.label12.Text = "HTML String with Custom Link Attributes"
			' 
			' urlPanel
			' 
			...
			Me.urlPanel.Location = New Point(6, 163)
...
'			Me.viewHtmlLinkLabel.LinkClicked += New System.Windows.Forms.LinkLabelLinkClickedEventHandler(Me.viewHtmlLinkLabel_LinkClicked)
			...
			Me.convertHtmlRadioButton.Size = New Size(259, 20)
			Me.convertHtmlRadioButton.TabIndex = 69
			Me.convertHtmlRadioButton.TabStop = True
			Me.convertHtmlRadioButton.Text = "Convert HTML with Custom Link Attributes"
...
'			Me.convertHtmlRadioButton.CheckedChanged += New System.EventHandler(Me.convertHtmlRadioButton_CheckedChanged)
			...
			Me.convertUrlRadioButton.Location = New Point(292, 8)
...
'			Me.convertUrlRadioButton.CheckedChanged += New System.EventHandler(Me.convertUrlRadioButton_CheckedChanged)
			...
			Me.descriptionPanel.Size = New Size(598, 84)
			...
			Me.descriptionLabel.Size = New Size(598, 84)
			...
			Me.titleLabel.Size = New Size(252, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Define Custom URI Links in HTML"
			' 
			...
			Me.Name = "Define_Custom_URI_Links_Demo"
			Me.Size = New Size(610, 707)
'			Me.Load += New System.EventHandler(Me.Define_Custom_URI_Links_Demo_Load)
