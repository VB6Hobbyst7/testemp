Namespace EvoHtmlToPdfDemo.HTML_to_PDF.URI_Links
	Partial Public Class Convert_URI_Links_to_PDF_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Convert_URI_Links_to_PDF_Demo))
			...
			Me.enableUriLinksCheckBox = New CheckBox()
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			' settingsPanel
			' 
			Me.settingsPanel.Controls.Add(Me.enableUriLinksCheckBox)
			Me.settingsPanel.Dock = DockStyle.Top
			Me.settingsPanel.Location = New Point(6, 178)
			Me.settingsPanel.Name = "settingsPanel"
			Me.settingsPanel.Size = New Size(598, 50)
			Me.settingsPanel.TabIndex = 129
			' 
			' enableUriLinksCheckBox
			' 
			Me.enableUriLinksCheckBox.AutoSize = True
			Me.enableUriLinksCheckBox.Checked = True
			Me.enableUriLinksCheckBox.CheckState = CheckState.Checked
			Me.enableUriLinksCheckBox.Location = New Point(9, 15)
			Me.enableUriLinksCheckBox.Name = "enableUriLinksCheckBox"
			Me.enableUriLinksCheckBox.Size = New Size(188, 21)
			Me.enableUriLinksCheckBox.TabIndex = 1
			Me.enableUriLinksCheckBox.Text = "Enable the URI Links in PDF"
			Me.enableUriLinksCheckBox.UseVisualStyleBackColor = True
			' 
			' urlPanel
			' 
			...
			Me.descriptionPanel.TabIndex = 127
			' 
			' descriptionLabel
			' 
			...
			Me.titleLabel.Text = "Convert URI Links from HTML to PDF"
			' 
			...
			Me.Name = "Convert_URI_Links_to_PDF_Demo"
		...
		Private enableUriLinksCheckBox As CheckBox
