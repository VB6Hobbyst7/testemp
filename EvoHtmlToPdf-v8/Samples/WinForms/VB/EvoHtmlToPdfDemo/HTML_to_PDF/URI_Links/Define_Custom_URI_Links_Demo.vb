...
Namespace EvoHtmlToPdfDemo.HTML_to_PDF.URI_Links
	Partial Public Class Define_Custom_URI_Links_Demo
		...
		Private Sub convertToPdfButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles convertToPdfButton.Click
			...
			Dim outPdfFile As String = "DemoAppFiles\Output\HTML_to_PDF\Custom_URI_Links.pdf"
			Try
		...
		Private Sub Define_Custom_URI_Links_Demo_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
