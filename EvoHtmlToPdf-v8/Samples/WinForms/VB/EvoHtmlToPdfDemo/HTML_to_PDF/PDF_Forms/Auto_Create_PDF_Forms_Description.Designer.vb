Namespace EvoHtmlToPdfDemo.HTML_to_PDF.PDF_Forms
	Partial Public Class Auto_Create_PDF_Forms_Description
		...
		Private Sub InitializeComponent()
			...
			Me.descriptionBottomPane.Size = New Size(575, 7)
			Me.descriptionBottomPane.TabIndex = 10
			' 
			' descriptionTopPanel
			' 
			...
			Me.descriptionTopPanel.Size = New Size(575, 7)
			Me.descriptionTopPanel.TabIndex = 9
			' 
			...
			Me.descriptionPanel.Size = New Size(563, 691)
			Me.descriptionPanel.TabIndex = 20
			' 
			...
			Me.descriptionWebBrowser.Size = New Size(563, 691)
			...
			Me.descriptionSeparatorPanel.Size = New Size(563, 10)
			Me.descriptionSeparatorPanel.TabIndex = 19
			' 
			...
			Me.descriptionTitlePanel.Size = New Size(563, 35)
			Me.descriptionTitlePanel.TabIndex = 18
			' 
			' titleLabel
			' 
			...
			Me.titleLabel.Size = New Size(263, 17)
			Me.titleLabel.TabIndex = 0
			Me.titleLabel.Text = "Convert HTML Forms to PDF Forms"
			' 
			' Auto_Create_PDF_Forms_Description
			' 
			...
			Me.Name = "Auto_Create_PDF_Forms_Description"
			Me.Size = New Size(575, 750)
'			Me.Load += New System.EventHandler(Me.PDF_Forms_Description_Load)
