Namespace EvoHtmlToPdfDemo.HTML_to_PDF.Fonts_Embedding
	Partial Public Class Embed_Fonts_in_PDF_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Embed_Fonts_in_PDF_Demo))
			...
			Me.embedFontsCheckBox = New CheckBox()
			...
			Me.convertButtonPanel.Location = New Point(6, 467)
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			' settingsPanel
			' 
			Me.settingsPanel.Controls.Add(Me.embedFontsCheckBox)
			Me.settingsPanel.Dock = DockStyle.Top
			Me.settingsPanel.Location = New Point(6, 414)
			...
			' embedFontsCheckBox
			' 
			Me.embedFontsCheckBox.AutoSize = True
			Me.embedFontsCheckBox.Checked = True
			Me.embedFontsCheckBox.CheckState = CheckState.Checked
			Me.embedFontsCheckBox.Location = New Point(6, 15)
			Me.embedFontsCheckBox.Name = "embedFontsCheckBox"
			Me.embedFontsCheckBox.Size = New Size(106, 21)
			Me.embedFontsCheckBox.TabIndex = 0
			Me.embedFontsCheckBox.Text = "Embed Fonts"
			Me.embedFontsCheckBox.UseVisualStyleBackColor = True
			' 
			' htmlStringPanel
			' 
			...
			Me.htmlStringPanel.Location = New Point(6, 191)
			...
			Me.selectHtmlToConvertPanel.Location = New Point(6, 96)
...
'			Me.convertUrlRadioButton.CheckedChanged += New System.EventHandler(Me.convertUrlRadioButton_CheckedChanged)
			...
			Me.titleLabel.Location = New Point(0, 3)
			Me.titleLabel.Name = "titleLabel"
			Me.titleLabel.Size = New Size(314, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Embed Fonts in Generated PDF Document"
			' 
			...
			Me.Name = "Embed_Fonts_in_PDF_Demo"
		...
		Private embedFontsCheckBox As CheckBox
	End Class
End Namespace
