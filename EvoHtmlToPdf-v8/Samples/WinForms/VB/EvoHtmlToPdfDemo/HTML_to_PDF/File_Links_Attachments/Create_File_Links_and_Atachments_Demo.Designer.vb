Namespace EvoHtmlToPdfDemo.HTML_to_PDF.File_Links_Attachments
	Partial Public Class Create_File_Links_and_Atachments_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Create_File_Links_and_Atachments_Demo))
			...
			Me.demoLeftPanel.Size = New Size(6, 678)
			...
			Me.demoRightPanel.Size = New Size(6, 678)
			Me.demoRightPanel.TabIndex = 140
			' 
			' demoBottomPanel
			' 
			Me.demoBottomPanel.Dock = DockStyle.Bottom
			Me.demoBottomPanel.Location = New Point(0, 684)
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			Me.label12.Size = New Size(370, 15)
			Me.label12.TabIndex = 50
			Me.label12.Text = "HTML String with Markers for File Links and Attachments"
			' 
			' descriptionPanel
			' 
			...
			Me.descriptionPanel.Size = New Size(598, 94)
			...
			Me.descriptionLabel.Size = New Size(598, 94)
			...
			Me.titleLabel.Size = New Size(449, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Add File Links and Attachments to Generated PDF Document"
			' 
			...
			Me.Name = "Create_File_Links_and_Atachments_Demo"
			Me.Size = New Size(610, 690)
'			Me.Load += New System.EventHandler(Me.Add_File_Links_and_Atachments_Demo_Load)
