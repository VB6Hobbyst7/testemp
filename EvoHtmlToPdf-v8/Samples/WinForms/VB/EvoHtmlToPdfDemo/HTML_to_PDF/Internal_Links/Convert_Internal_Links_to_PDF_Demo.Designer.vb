Namespace EvoHtmlToPdfDemo.HTML_to_PDF.Internal_Links
	Partial Public Class Convert_Internal_Links_to_PDF_Demo
		''' <summary> 
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Convert_Internal_Links_to_PDF_Demo))
			...
			Me.enableInternalLinksCheckBox = New CheckBox()
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			' settingsPanel
			' 
			Me.settingsPanel.Controls.Add(Me.enableInternalLinksCheckBox)
			Me.settingsPanel.Dock = DockStyle.Top
			Me.settingsPanel.Location = New Point(6, 178)
			...
			' 
			Me.enableInternalLinksCheckBox.AutoSize = True
			Me.enableInternalLinksCheckBox.Checked = True
			Me.enableInternalLinksCheckBox.CheckState = CheckState.Checked
			Me.enableInternalLinksCheckBox.Location = New Point(9, 15)
			Me.enableInternalLinksCheckBox.Name = "enableInternalLinksCheckBox"
			Me.enableInternalLinksCheckBox.Size = New Size(208, 21)
			Me.enableInternalLinksCheckBox.TabIndex = 1
			Me.enableInternalLinksCheckBox.Text = "Enable the Internal Links in PDF"
			Me.enableInternalLinksCheckBox.UseVisualStyleBackColor = True
			' 
			' urlPanel
			' 
			...
			Me.viewHtmlLinkLabel.Location = New Point(515, 37)
...
'			Me.viewHtmlLinkLabel.LinkClicked += New System.Windows.Forms.LinkLabelLinkClickedEventHandler(Me.viewHtmlLinkLabel_LinkClicked)
			...
			Me.titleLabel.Size = New Size(305, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Convert Internal Links from HTML to PDF"
			' 
			...
			Me.Name = "Convert_Internal_Links_to_PDF_Demo"
		...
		Private enableInternalLinksCheckBox As CheckBox
