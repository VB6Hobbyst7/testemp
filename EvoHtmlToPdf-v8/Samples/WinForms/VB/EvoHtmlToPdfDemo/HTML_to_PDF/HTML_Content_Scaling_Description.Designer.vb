Namespace EvoHtmlToPdfDemo.HTML_to_PDF
	Partial Public Class HTML_Content_Scaling_Description
		...
		Private Sub InitializeComponent()
			...
			Me.descriptionBottomPane.TabIndex = 4
			' 
			' descriptionTopPanel
			' 
			...
			Me.descriptionTopPanel.TabIndex = 3
			' 
			...
			Me.descriptionLeftPanel.TabIndex = 7
			' 
			...
			Me.descriptionRightPanel.TabIndex = 6
			' 
			' descriptionPanel
			' 
			...
			Me.descriptionPanel.TabIndex = 11
			' 
			...
			Me.descriptionSeparatorPanel.TabIndex = 10
			' 
			...
			Me.descriptionTitlePanel.TabIndex = 9
			' 
			' titleLabel
			' 
			...
			Me.titleLabel.Size = New Size(260, 17)
			...
			Me.Name = "HTML_Content_Scaling_Description"
			Me.Size = New Size(610, 650)
'			Me.Load += New System.EventHandler(Me.HTML_Content_Scaling_Description_Load)
