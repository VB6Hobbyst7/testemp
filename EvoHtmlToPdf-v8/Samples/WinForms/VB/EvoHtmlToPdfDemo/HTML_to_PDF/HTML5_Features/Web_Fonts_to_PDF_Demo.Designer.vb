Namespace EvoHtmlToPdfDemo.HTML_to_PDF.HTML5_Features
	Partial Public Class Web_Fonts_to_PDF_Demo
		''' <summary> 
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Web_Fonts_to_PDF_Demo))
...
'			Me.viewHtmlLinkLabel.LinkClicked += New System.Windows.Forms.LinkLabelLinkClickedEventHandler(Me.viewHtmlLinkLabel_LinkClicked)
			...
			Me.enterUrlLabel.Size = New Size(298, 15)
			Me.enterUrlLabel.TabIndex = 42
			Me.enterUrlLabel.Text = "HTML Page with Web Fonts to Convert to PDF"
			' 
			' urlTextBox
			' 
			...
			Me.urlTextBox.Text = "http://www.evopdf.com/DemoAppFiles/HTML_Files/Web_Fonts.html"
			' 
			' descriptionPanel
			' 
			...
			Me.descriptionPanel.TabIndex = 129
			' 
			' descriptionLabel
			' 
			...
			Me.titleLabel.Size = New Size(280, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Convert HTML with Web Fonts to PDF"
			' 
