Namespace EvoHtmlToPdfDemo.HTML_to_PDF.HTML_to_Image_Elements
	Partial Public Class Add_HTML_to_Image_Elements_to_PDF_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Add_HTML_to_Image_Elements_to_PDF_Demo))
			...
			Me.demoRightPanel.TabIndex = 138
			' 
			' demoBottomPanel
			' 
			...
			Me.demoBottomPanel.TabIndex = 137
			' 
			' demoTopPanel
			' 
			...
			Me.urlPanel.Location = New Point(6, 117)
			Me.urlPanel.Name = "urlPanel"
			Me.urlPanel.Size = New Size(598, 76)
			Me.urlPanel.TabIndex = 156
			' 
			' enterUrlLabel
			' 
			...
			Me.descriptionPanel.Size = New Size(598, 71)
			...
			Me.descriptionLabel.Size = New Size(598, 71)
			...
			Me.titleLabel.Size = New Size(366, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Add HTML to Image Elements to a PDF Document"
			' 
			' settingsPanel
			' 
			...
			Me.settingsPanel.Location = New Point(6, 193)
			Me.settingsPanel.Name = "settingsPanel"
			Me.settingsPanel.Size = New Size(598, 137)
			Me.settingsPanel.TabIndex = 157
			' 
			' label31
			' 
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			' 
			' Add_HTML_to_Image_Elements_to_PDF_Demo
			' 
			...
			Me.Name = "Add_HTML_to_Image_Elements_to_PDF_Demo"
