Namespace EvoHtmlToPdfDemo.HTML_to_PDF.HTML_Elements_Location
	Partial Public Class Select_in_API_Elements_to_Retrieve_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Select_in_API_Elements_to_Retrieve_Demo))
			...
			Me.convertButtonPanel.Location = New Point(6, 257)
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			Me.settingsPanel.Location = New Point(6, 186)
			...
			Me.label1.Size = New Size(275, 15)
			Me.label1.TabIndex = 42
			Me.label1.Text = "HTML Elements to Highlight CSS Selector"
			' 
			...
			Me.htmlElementsSelectorTextBox.Text = "H1, H2, H3, H4, H5, H6"
			' 
			' urlPanel
			' 
			...
			Me.urlPanel.Location = New Point(6, 119)
			Me.urlPanel.Name = "urlPanel"
			Me.urlPanel.Size = New Size(598, 67)
			Me.urlPanel.TabIndex = 144
			' 
			' enterUrlLabel
			' 
			...
			Me.descriptionPanel.Size = New Size(598, 73)
			...
			Me.descriptionLabel.Size = New Size(598, 73)
			...
			Me.titleLabel.Size = New Size(468, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Select in API the HTML Elements for which to Retrieve Location"
			' 
			...
			Me.Name = "Select_in_API_Elements_to_Retrieve_Demo"
