Namespace EvoHtmlToPdfDemo.HTML_to_PDF.HTML_Elements_Location
	Partial Public Class Select_in_HTML_Elements_to_Retrieve_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Select_in_HTML_Elements_to_Retrieve_Demo))
			...
			Me.demoLeftPanel.Size = New Size(6, 753)
			Me.demoLeftPanel.TabIndex = 121
			' 
			' demoRightPanel
			' 
			...
			Me.demoRightPanel.Size = New Size(6, 753)
			Me.demoRightPanel.TabIndex = 120
			' 
			' demoBottomPanel
			' 
			Me.demoBottomPanel.Dock = DockStyle.Bottom
			Me.demoBottomPanel.Location = New Point(0, 759)
			Me.demoBottomPanel.Name = "demoBottomPanel"
			Me.demoBottomPanel.Size = New Size(610, 6)
			Me.demoBottomPanel.TabIndex = 119
			' 
			' demoTopPanel
			' 
			...
			Me.convertButtonPanel.TabIndex = 130
			' 
			' convertToPdfButton
			' 
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			Me.htmlPanel.Location = New Point(6, 261)
			Me.htmlPanel.Name = "htmlPanel"
			Me.htmlPanel.Size = New Size(598, 411)
			Me.htmlPanel.TabIndex = 129
			' 
			' label2
			' 
			...
			Me.label12.Size = New Size(241, 15)
			Me.label12.TabIndex = 42
			Me.label12.Text = "HTML String with Mapping Attributes"
			' 
			' urlPanel
			' 
			...
			Me.urlPanel.Location = New Point(6, 179)
			Me.urlPanel.Name = "urlPanel"
			Me.urlPanel.Size = New Size(598, 82)
			Me.urlPanel.TabIndex = 128
...
'			Me.viewHtmlLinkLabel.LinkClicked += New System.Windows.Forms.LinkLabelLinkClickedEventHandler(Me.viewHtmlLinkLabel_LinkClicked)
			...
			Me.convertHtmlRadioButton.Size = New Size(240, 20)
			Me.convertHtmlRadioButton.TabIndex = 69
			Me.convertHtmlRadioButton.TabStop = True
			Me.convertHtmlRadioButton.Text = "Convert HTML with Mapping Attributes"
...
'			Me.convertUrlRadioButton.CheckedChanged += New System.EventHandler(Me.convertUrlRadioButton_CheckedChanged)
			...
			Me.descriptionPanel.Size = New Size(598, 100)
			Me.descriptionPanel.TabIndex = 126
			' 
			' descriptionLabel
			' 
			...
			Me.descriptionLabel.Size = New Size(598, 100)
			...
			Me.titleLabel.Size = New Size(462, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Select in HTML the Elements for Which to Retrieve Information"
			' 
			...
			Me.Name = "Select_in_HTML_Elements_to_Retrieve_Demo"
			Me.Size = New Size(610, 765)
'			Me.Load += New System.EventHandler(Me.Select_in_HTML_Elements_to_Retrieve_Demo_Load)
