...
Namespace EvoHtmlToPdfDemo.HTML_to_PDF
	Partial Public Class HTML_Content_Scaling_Demo
		...
		Private Sub convertToPdfButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles convertToPdfButton.Click
			...
			Dim outPdfFile As String = "DemoAppFiles\Output\HTML_to_PDF\HTML_Content_Scaling.pdf"
			Try
		...
		Private Sub HTML_Content_Scaling_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
		...
		Private Sub fitWidthCheckBox_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles fitWidthCheckBox.CheckedChanged
