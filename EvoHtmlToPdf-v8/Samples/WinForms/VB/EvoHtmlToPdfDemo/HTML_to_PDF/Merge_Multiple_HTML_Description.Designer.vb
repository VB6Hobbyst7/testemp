Namespace EvoHtmlToPdfDemo.HTML_to_PDF
	Partial Public Class Merge_Multiple_HTML_Description
		...
		Private Sub InitializeComponent()
			...
			Me.descriptionBottomPane.TabIndex = 6
			' 
			' descriptionTopPanel
			' 
			...
			Me.descriptionTopPanel.TabIndex = 5
			' 
			...
			Me.descriptionLeftPanel.TabIndex = 9
			' 
			...
			Me.descriptionRightPanel.TabIndex = 8
			' 
			' descriptionPanel
			' 
			...
			Me.descriptionPanel.TabIndex = 14
			' 
			...
			Me.descriptionSeparatorPanel.TabIndex = 13
			' 
			...
			Me.descriptionTitlePanel.TabIndex = 12
			' 
			' titleLabel
			' 
			...
			Me.titleLabel.Size = New Size(342, 17)
			...
			Me.Name = "Merge_Multiple_HTML_Description"
			Me.Size = New Size(610, 650)
'			Me.Load += New System.EventHandler(Me.Merge_Multiple_HTML_Description_Load)
