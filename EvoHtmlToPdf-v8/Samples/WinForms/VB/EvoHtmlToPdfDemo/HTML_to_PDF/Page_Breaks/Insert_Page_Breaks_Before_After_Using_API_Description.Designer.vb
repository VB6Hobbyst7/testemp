Namespace EvoHtmlToPdfDemo.HTML_to_PDF.Page_Breaks
	Partial Public Class Insert_Page_Breaks_Before_After_Using_API_Description
		...
		Private Sub InitializeComponent()
			...
			Me.descriptionPanel.Size = New Size(598, 683)
			Me.descriptionPanel.TabIndex = 31
			' 
			...
			Me.descriptionWebBrowser.Size = New Size(598, 683)
			...
			Me.descriptionSeparatorPanel.TabIndex = 30
			' 
			...
			Me.descriptionTitlePanel.TabIndex = 29
			' 
			' titleLabel
			' 
			...
			Me.descriptionLeftPanel.Size = New Size(6, 728)
			Me.descriptionLeftPanel.TabIndex = 28
			' 
			...
			Me.descriptionRightPanel.Size = New Size(6, 728)
			Me.descriptionRightPanel.TabIndex = 27
			' 
			' descriptionBottomPane
			' 
			Me.descriptionBottomPane.Dock = DockStyle.Bottom
			Me.descriptionBottomPane.Location = New Point(0, 734)
			Me.descriptionBottomPane.Name = "descriptionBottomPane"
			Me.descriptionBottomPane.Size = New Size(610, 6)
			Me.descriptionBottomPane.TabIndex = 26
			' 
			' descriptionTopPanel
			' 
			...
			Me.descriptionTopPanel.TabIndex = 25
			' 
			...
			Me.Name = "Insert_Page_Breaks_Before_After_Using_API_Description"
			Me.Size = New Size(610, 740)
'			Me.Load += New System.EventHandler(Me.Insert_Page_Breaks_Before_After_Using_API_Description_Load)
