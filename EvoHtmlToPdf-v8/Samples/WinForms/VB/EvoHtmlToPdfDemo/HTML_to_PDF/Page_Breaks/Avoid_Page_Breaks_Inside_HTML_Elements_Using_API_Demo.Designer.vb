Namespace EvoHtmlToPdfDemo.HTML_to_PDF.Page_Breaks
	Partial Public Class Avoid_Page_Breaks_Inside_HTML_Elements_Using_API_Demo
		''' <summary> 
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Avoid_Page_Breaks_Inside_HTML_Elements_Using_API_Demo))
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			Me.htmlPanel.Location = New Point(6, 276)
			Me.htmlPanel.Name = "htmlPanel"
			Me.htmlPanel.Size = New Size(598, 399)
			Me.htmlPanel.TabIndex = 138
			' 
			' label2
			' 
			Me.label2.AutoSize = True
			Me.label2.Font = New Font("Microsoft Sans Serif", 12F, FontStyle.Bold, GraphicsUnit.Pixel)
			Me.label2.Location = New Point(6, 349)
			...
			' baseUrlTextBox
			' 
			Me.baseUrlTextBox.Location = New Point(9, 367)
			...
			Me.htmlStringTextBox.Size = New Size(574, 301)
			...
			Me.urlPanel.Location = New Point(6, 209)
			Me.urlPanel.Name = "urlPanel"
			Me.urlPanel.Size = New Size(598, 67)
			Me.urlPanel.TabIndex = 137
...
'			Me.viewHtmlLinkLabel.LinkClicked += New System.Windows.Forms.LinkLabelLinkClickedEventHandler(Me.viewHtmlLinkLabel_LinkClicked)
			...
			Me.panel2.Controls.Add(Me.htmlElementsSelectorTextBox)
			...
			Me.panel2.Location = New Point(6, 102)
			Me.panel2.Name = "panel2"
			Me.panel2.Size = New Size(598, 107)
			...
			Me.label1.Size = New Size(480, 15)
			Me.label1.TabIndex = 72
			Me.label1.Text = "CSS Selector of the HTML Elements for Which to Avoid Page Break Inside "
			' 
			...
			Me.htmlElementsSelectorTextBox.TabIndex = 73
			Me.htmlElementsSelectorTextBox.Text = "#page_break_inside_avoid_table TR"
			' 
			' convertHtmlRadioButton
			' 
			Me.convertHtmlRadioButton.AutoSize = True
			Me.convertHtmlRadioButton.Checked = True
			Me.convertHtmlRadioButton.Location = New Point(9, 82)
...
'			Me.convertHtmlRadioButton.CheckedChanged += New System.EventHandler(Me.convertHtmlRadioButton_CheckedChanged)
			...
			Me.convertUrlRadioButton.Location = New Point(192, 82)
...
'			Me.convertUrlRadioButton.CheckedChanged += New System.EventHandler(Me.convertUrlRadioButton_CheckedChanged)
			...
			Me.descriptionPanel.TabIndex = 135
			' 
			' descriptionLabel
			' 
			...
			Me.titleLabel.Size = New Size(386, 17)
			...
			Me.demoRightPanel.TabIndex = 132
			' 
			' demoBottomPanel
			' 
			...
			Me.demoBottomPanel.TabIndex = 131
			' 
			' demoTopPanel
			' 
			...
			Me.Name = "Avoid_Page_Breaks_Inside_HTML_Elements_Using_API_Demo"
			Me.Size = New Size(610, 740)
'			Me.Load += New System.EventHandler(Me.Avoid_Page_Breaks_Inside_HTML_Elements_Using_API_Demo_Load)
