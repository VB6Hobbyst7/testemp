...
Namespace EvoHtmlToPdfDemo.HTML_to_PDF.Page_Breaks
	Partial Public Class Avoid_Page_Breaks_Inside_HTML_Elements_Using_API_Demo
		...
		Private Sub convertToPdfButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles convertToPdfButton.Click
			...
			Dim outPdfFile As String = "DemoAppFiles\Output\HTML_to_PDF\Avoid_Page_Breaks_Inside_HTML_Elements_Using_API.pdf"
			Try
		...
		Private Sub Avoid_Page_Breaks_Inside_HTML_Elements_Using_API_Demo_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
