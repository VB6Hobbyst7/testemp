Namespace EvoHtmlToPdfDemo.HTML_to_PDF.Page_Breaks
	Partial Public Class Insert_Page_Breaks_Before_After_Using_API_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Insert_Page_Breaks_Before_After_Using_API_Demo))
			...
			Me.panel2 = New Panel()
			Me.label3 = New Label()
			Me.htmlElementsAfterSelectorTextBox = New TextBox()
			Me.label1 = New Label()
			Me.htmlElementsBeforeSelectorTextBox = New TextBox()
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			Me.htmlPanel.Location = New Point(6, 340)
			Me.htmlPanel.Name = "htmlPanel"
			Me.htmlPanel.Size = New Size(598, 337)
			Me.htmlPanel.TabIndex = 142
			' 
			' label2
			' 
			Me.label2.AutoSize = True
			Me.label2.Font = New Font("Microsoft Sans Serif", 12F, FontStyle.Bold, GraphicsUnit.Pixel)
			Me.label2.Location = New Point(6, 287)
			...
			' baseUrlTextBox
			' 
			Me.baseUrlTextBox.Location = New Point(9, 305)
			...
			Me.htmlStringTextBox.Size = New Size(574, 239)
			...
			Me.urlPanel.Location = New Point(6, 273)
			Me.urlPanel.Name = "urlPanel"
			Me.urlPanel.Size = New Size(598, 67)
			Me.urlPanel.TabIndex = 141
...
'			Me.viewHtmlLinkLabel.LinkClicked += New System.Windows.Forms.LinkLabelLinkClickedEventHandler(Me.viewHtmlLinkLabel_LinkClicked)
			...
			Me.panel2.Controls.Add(Me.htmlElementsAfterSelectorTextBox)
			Me.panel2.Controls.Add(Me.label1)
			Me.panel2.Controls.Add(Me.htmlElementsBeforeSelectorTextBox)
			...
			Me.panel2.Location = New Point(6, 110)
			Me.panel2.Name = "panel2"
			Me.panel2.Size = New Size(598, 163)
			...
			Me.label3.Size = New Size(454, 15)
			Me.label3.TabIndex = 74
			Me.label3.Text = "CSS Selector of the HTML Elements After Which to Insert Page Breaks"
			' 
			' htmlElementsAfterSelectorTextBox
			' 
			Me.htmlElementsAfterSelectorTextBox.Location = New Point(8, 91)
			Me.htmlElementsAfterSelectorTextBox.Name = "htmlElementsAfterSelectorTextBox"
			Me.htmlElementsAfterSelectorTextBox.Size = New Size(576, 21)
			Me.htmlElementsAfterSelectorTextBox.TabIndex = 75
			Me.htmlElementsAfterSelectorTextBox.Text = "#page_break_before_and_after_div , #page_break_after_div"
			' 
			' label1
			' 
			...
			Me.label1.Size = New Size(467, 15)
			Me.label1.TabIndex = 74
			Me.label1.Text = "CSS Selector of the HTML Elements Before Which to Insert Page Breaks"
			' 
			' htmlElementsBeforeSelectorTextBox
			' 
			Me.htmlElementsBeforeSelectorTextBox.Location = New Point(8, 33)
			Me.htmlElementsBeforeSelectorTextBox.Name = "htmlElementsBeforeSelectorTextBox"
			Me.htmlElementsBeforeSelectorTextBox.Size = New Size(576, 21)
			Me.htmlElementsBeforeSelectorTextBox.TabIndex = 75
			Me.htmlElementsBeforeSelectorTextBox.Text = "#page_break_before_and_after_div , #page_break_before_div"
			' 
			' convertHtmlRadioButton
			' 
			Me.convertHtmlRadioButton.AutoSize = True
			Me.convertHtmlRadioButton.Checked = True
			Me.convertHtmlRadioButton.Location = New Point(9, 138)
...
'			Me.convertHtmlRadioButton.CheckedChanged += New System.EventHandler(Me.convertHtmlRadioButton_CheckedChanged)
			...
			Me.convertUrlRadioButton.Location = New Point(192, 138)
...
'			Me.convertUrlRadioButton.CheckedChanged += New System.EventHandler(Me.convertUrlRadioButton_CheckedChanged)
			...
			Me.descriptionPanel.TabIndex = 139
			' 
			' descriptionLabel
			' 
			...
			Me.titleLabel.Size = New Size(517, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Insert Page Breaks Before and After HTML Elements in PDF Using API"
			' 
			' demoLeftPanel
			' 
			...
			Me.demoLeftPanel.Size = New Size(6, 728)
			Me.demoLeftPanel.TabIndex = 137
			' 
			' demoRightPanel
			' 
			...
			Me.demoRightPanel.Size = New Size(6, 728)
			Me.demoRightPanel.TabIndex = 136
			' 
			' demoBottomPanel
			' 
			Me.demoBottomPanel.Dock = DockStyle.Bottom
			Me.demoBottomPanel.Location = New Point(0, 734)
			Me.demoBottomPanel.Name = "demoBottomPanel"
			Me.demoBottomPanel.Size = New Size(610, 6)
			Me.demoBottomPanel.TabIndex = 135
			' 
			' demoTopPanel
			' 
			...
			Me.Name = "Insert_Page_Breaks_Before_After_Using_API_Demo"
			Me.Size = New Size(610, 740)
'			Me.Load += New System.EventHandler(Me.Insert_Page_Breaks_Before_After_Using_API_Demo_Load)
		...
		Private htmlElementsBeforeSelectorTextBox As TextBox
		Private label3 As Label
		Private htmlElementsAfterSelectorTextBox As TextBox
	End Class
End Namespace
