Namespace EvoHtmlToPdfDemo.HTML_to_PDF.Page_Breaks
	Partial Public Class Insert_Page_Breaks_Before_After_Using_CSS_Demo
		''' <summary> 
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Insert_Page_Breaks_Before_After_Using_CSS_Demo))
			...
			Me.settingsPanel.Location = New Point(6, 101)
			...
			Me.titleLabel.Size = New Size(546, 18)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Insert Page Breaks Before and After HTML Elements in PDF Using CSS"
			' 
			' demoLeftPanel
			' 
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			Me.htmlPanel.Location = New Point(6, 206)
			Me.htmlPanel.Name = "htmlPanel"
			Me.htmlPanel.Size = New Size(598, 461)
			Me.htmlPanel.TabIndex = 132
			' 
			' label2
			' 
			Me.label2.AutoSize = True
			Me.label2.Font = New Font("Microsoft Sans Serif", 12F, FontStyle.Bold, GraphicsUnit.Pixel)
			Me.label2.Location = New Point(6, 406)
			...
			' baseUrlTextBox
			' 
			Me.baseUrlTextBox.Location = New Point(9, 424)
			...
			Me.label12.Size = New Size(466, 16)
			Me.label12.TabIndex = 50
			Me.label12.Text = "HTML String With Page-Break-Before and Page-Break-After Styles"
			' 
			' urlPanel
			' 
			...
			Me.urlPanel.Location = New Point(6, 139)
			Me.urlPanel.Name = "urlPanel"
			Me.urlPanel.Size = New Size(598, 67)
			Me.urlPanel.TabIndex = 131
...
'			Me.viewHtmlLinkLabel.LinkClicked += New System.Windows.Forms.LinkLabelLinkClickedEventHandler(Me.viewHtmlLinkLabel_LinkClicked)
			...
			Me.enterUrlLabel.Size = New Size(463, 16)
			Me.enterUrlLabel.TabIndex = 42
			Me.enterUrlLabel.Text = "HTML Page With Page-Break-Before and Page-Break-After Styles"
			' 
			' urlTextBox
			' 
...
'			Me.convertUrlRadioButton.CheckedChanged += New System.EventHandler(Me.convertUrlRadioButton_CheckedChanged)
			' 
			' Insert_Page_Breaks_Before_After_Using_CSS_Demo
			' 
			...
			Me.Name = "Insert_Page_Breaks_Before_After_Using_CSS_Demo"
			Me.Size = New Size(610, 740)
'			Me.Load += New System.EventHandler(Me.Insert_Page_Breaks_Before_After_Demo_Load)
