...
Namespace EvoHtmlToPdfDemo.HTML_to_PDF.Page_Breaks
	Partial Public Class Insert_Page_Breaks_Before_After_Using_CSS_Demo
		...
		Private Sub convertToPdfButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles convertToPdfButton.Click
			...
			Dim outPdfFile As String = "DemoAppFiles\Output\HTML_to_PDF\Insert_Page_Breaks_Before_After_HTML_Elements_Using_CSS.pdf"
			Try
		...
		Private Sub Insert_Page_Breaks_Before_After_Demo_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
