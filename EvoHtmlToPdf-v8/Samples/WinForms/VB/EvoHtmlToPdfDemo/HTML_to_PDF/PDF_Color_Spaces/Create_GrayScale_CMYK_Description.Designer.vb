Namespace EvoHtmlToPdfDemo.HTML_to_PDF.PDF_Color_Spaces
	Partial Public Class Create_GrayScale_CMYK_Description
		...
		Private Sub InitializeComponent()
			...
			Me.titleLabel.Text = "Convert HTML to GrayScale and CMYK PDF Documents"
			' 
			...
			Me.Name = "Create_GrayScale_CMYK_Description"
			Me.Size = New Size(610, 650)
'			Me.Load += New System.EventHandler(Me.Create_GrayScale_CMYK_Description_Load)
