Namespace EvoHtmlToPdfDemo.HTML_to_PDF.Headers_and_Footers
	Partial Public Class HTML_in_Header_Footer_Demo
		...
		Private Sub InitializeComponent()
			...
			Me.convertButtonPanel.Location = New Point(6, 443)
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			Me.settingsPanel.Location = New Point(6, 167)
			...
			Me.label1.Size = New Size(117, 16)
			...
			' descriptionLabel
			' 
			Me.descriptionLabel.Dock = DockStyle.Left
			Me.descriptionLabel.Location = New Point(0, 0)
			Me.descriptionLabel.Name = "descriptionLabel"
			Me.descriptionLabel.Size = New Size(600, 55)
			...
			Me.titleLabel.Size = New Size(250, 18)
