Namespace EvoHtmlToPdfDemo.HTML_to_PDF
	Partial Public Class Merge_With_Existing_PDF_Description
		''' <summary> 
		...
		Private Sub InitializeComponent()
			...
			Me.descriptionBottomPane.TabIndex = 8
			' 
			' descriptionTopPanel
			' 
			...
			Me.descriptionTopPanel.TabIndex = 7
			' 
			...
			Me.descriptionLeftPanel.TabIndex = 11
			' 
			...
			Me.descriptionRightPanel.TabIndex = 10
			' 
			' descriptionPanel
			' 
			...
			Me.descriptionSeparatorPanel.TabIndex = 16
			' 
			...
			Me.descriptionTitlePanel.TabIndex = 15
			' 
			' titleLabel
			' 
			...
			Me.titleLabel.Size = New Size(327, 17)
			...
			Me.Name = "Merge_With_Existing_PDF_Description"
			Me.Size = New Size(610, 650)
'			Me.Load += New System.EventHandler(Me.Merge_With_Existing_PDF_Description_Load)
