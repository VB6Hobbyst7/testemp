Namespace EvoHtmlToPdfDemo.HTML_to_PDF.Table_of_Contents
	Partial Public Class Define_in_HTML_Table_of_Contents_Items_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Define_in_HTML_Table_of_Contents_Items_Demo))
			...
			Me.demoLeftPanel.Size = New Size(6, 717)
			...
			Me.demoRightPanel.Size = New Size(6, 717)
			Me.demoRightPanel.TabIndex = 120
			' 
			' demoBottomPanel
			' 
			Me.demoBottomPanel.Dock = DockStyle.Bottom
			Me.demoBottomPanel.Location = New Point(0, 723)
			...
			Me.convertButtonPanel.Location = New Point(6, 659)
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			Me.label12.Size = New Size(249, 16)
			Me.label12.TabIndex = 42
			Me.label12.Text = "HTML String with Table of Contents"
			' 
			' urlPanel
			' 
...
'			Me.viewHtmlLinkLabel.LinkClicked += New System.Windows.Forms.LinkLabelLinkClickedEventHandler(Me.viewHtmlLinkLabel_LinkClicked)
			...
			Me.convertHtmlRadioButton.Size = New Size(248, 20)
			Me.convertHtmlRadioButton.TabIndex = 69
			Me.convertHtmlRadioButton.TabStop = True
			Me.convertHtmlRadioButton.Text = "Convert HTML with Table of Contents"
...
'			Me.convertUrlRadioButton.CheckedChanged += New System.EventHandler(Me.convertUrlRadioButton_CheckedChanged)
			...
			Me.titleLabel.Size = New Size(337, 18)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Define in HTML the Table of Contents Items"
			' 
			...
			Me.Name = "Define_in_HTML_Table_of_Contents_Items_Demo"
			Me.Size = New Size(610, 729)
'			Me.Load += New System.EventHandler(Me.Define_in_HTML_Table_of_Contents_Items_Demo_Load)
