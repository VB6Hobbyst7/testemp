Namespace EvoHtmlToPdfDemo.HTML_to_PDF.Bookmarks
	Partial Public Class Select_in_API_HTML_Elements_to_Bookmark_Description
		...
		Private Sub InitializeComponent()
			...
			Me.titleLabel.Size = New Size(341, 17)
			Me.titleLabel.TabIndex = 0
			Me.titleLabel.Text = "Select in API the HTML Elements to Bookmark"
			' 
			...
			Me.Name = "Select_in_API_HTML_Elements_to_Bookmark_Description"
			Me.Size = New Size(610, 650)
'			Me.Load += New System.EventHandler(Me.Select_in_API_HTML_Elements_to_Bookmark_Description_Load)
