Namespace EvoHtmlToPdfDemo.HTML_to_PDF.Bookmarks
	Partial Public Class Select_in_HTML_Elements_to_Bookmark_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Select_in_HTML_Elements_to_Bookmark_Demo))
			...
			Me.convertButtonPanel.TabIndex = 124
			' 
			' convertToPdfButton
			' 
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			Me.selectMediaTypePanel.Location = New Point(6, 671)
			Me.selectMediaTypePanel.Name = "selectMediaTypePanel"
			Me.selectMediaTypePanel.Size = New Size(598, 1)
			Me.selectMediaTypePanel.TabIndex = 123
			' 
			' htmlPanel
			' 
			...
			Me.htmlPanel.Location = New Point(6, 260)
			Me.htmlPanel.Name = "htmlPanel"
			Me.htmlPanel.Size = New Size(598, 411)
			Me.htmlPanel.TabIndex = 122
			' 
			' label2
			' 
			...
			Me.label12.Size = New Size(266, 16)
			Me.label12.TabIndex = 42
			Me.label12.Text = "HTML String with Bookmark Attributes"
			' 
			' urlPanel
			' 
...
'			Me.viewHtmlLinkLabel.LinkClicked += New System.Windows.Forms.LinkLabelLinkClickedEventHandler(Me.viewHtmlLinkLabel_LinkClicked)
			...
			Me.urlTextBox.Size = New Size(504, 21)
			...
			Me.convertHtmlRadioButton.Size = New Size(263, 20)
			Me.convertHtmlRadioButton.TabIndex = 69
			Me.convertHtmlRadioButton.TabStop = True
			Me.convertHtmlRadioButton.Text = "Convert HTML with Bookmark Attributes"
...
'			Me.convertHtmlRadioButton.CheckedChanged += New System.EventHandler(Me.convertHtmlRadioButton_CheckedChanged)
			...
			Me.convertUrlRadioButton.Location = New Point(280, 8)
...
'			Me.convertUrlRadioButton.CheckedChanged += New System.EventHandler(Me.convertUrlRadioButton_CheckedChanged)
			...
			Me.descriptionPanel.Size = New Size(598, 99)
			Me.descriptionPanel.TabIndex = 119
			' 
			' descriptionLabel
			' 
			...
			Me.descriptionLabel.Size = New Size(598, 99)
			...
			Me.titleLabel.Size = New Size(329, 18)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Select in HTML the Elements to Bookmark"
			' 
			' demoLeftPanel
			' 
			...
			Me.demoLeftPanel.Size = New Size(6, 714)
			Me.demoLeftPanel.TabIndex = 117
			' 
			' demoRightPanel
			' 
			...
			Me.demoRightPanel.Size = New Size(6, 714)
			Me.demoRightPanel.TabIndex = 116
			' 
			' demoBottomPanel
			' 
			Me.demoBottomPanel.Dock = DockStyle.Bottom
			Me.demoBottomPanel.Location = New Point(0, 720)
			Me.demoBottomPanel.Name = "demoBottomPanel"
			Me.demoBottomPanel.Size = New Size(610, 6)
			Me.demoBottomPanel.TabIndex = 115
			' 
			' demoTopPanel
			' 
			...
			Me.demoTopPanel.TabIndex = 114
			' 
			' Select_in_HTML_Elements_to_Bookmark_Demo
			' 
			...
			Me.Name = "Select_in_HTML_Elements_to_Bookmark_Demo"
			Me.Size = New Size(610, 726)
'			Me.Load += New System.EventHandler(Me.Select_in_HTML_Elements_to_Bookmark_Demo_Load)
