Namespace EvoHtmlToPdfDemo.HTML_to_PDF.Bookmarks
	Partial Public Class Auto_Create_Bookmarks_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Auto_Create_Bookmarks_Demo))
			Me.convertButtonPanel = New Panel()
			Me.convertToPdfButton = New Button()
			Me.settingsPanel = New Panel()
			Me.autoBookmarksCheckBox = New CheckBox()
			...
			Me.convertButtonPanel.Location = New Point(6, 216)
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			' settingsPanel
			' 
			Me.settingsPanel.Controls.Add(Me.autoBookmarksCheckBox)
			Me.settingsPanel.Dock = DockStyle.Top
			Me.settingsPanel.Location = New Point(6, 166)
			...
			' 
			Me.autoBookmarksCheckBox.AutoSize = True
			Me.autoBookmarksCheckBox.Checked = True
			Me.autoBookmarksCheckBox.CheckState = CheckState.Checked
			Me.autoBookmarksCheckBox.Location = New Point(9, 15)
			Me.autoBookmarksCheckBox.Name = "autoBookmarksCheckBox"
			Me.autoBookmarksCheckBox.Size = New Size(346, 20)
			Me.autoBookmarksCheckBox.TabIndex = 1
			Me.autoBookmarksCheckBox.Text = "Create a Hierarchy of Bookmarks from H1 to H6 Tags"
			Me.autoBookmarksCheckBox.UseVisualStyleBackColor = True
			' 
			' urlPanel
			' 
			...
			Me.urlTextBox.Size = New Size(575, 21)
			...
			Me.titleLabel.Size = New Size(284, 18)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Auto Create Hierarchical Bookmarks"
			' 
			' demoLeftPanel
			' 
			...
			Me.demoRightPanel.TabIndex = 128
			' 
			' demoBottomPanel
			' 
			...
			Me.demoBottomPanel.TabIndex = 127
			' 
			' demoTopPanel
			' 
			...
			Me.Name = "Auto_Create_Bookmarks_Demo"
		...
		Private autoBookmarksCheckBox As CheckBox
