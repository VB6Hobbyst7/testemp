...
Namespace EvoHtmlToPdfDemo.HTML_to_PDF
	Partial Public Class Repeat_HTML_Table_Header_Footer_Demo
		...
		Private Sub convertToPdfButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles convertToPdfButton.Click
			...
			Dim outPdfFile As String = "DemoAppFiles\Output\HTML_to_PDF\Repeat_HTML_Table_Header_Footer.pdf"
			Try
		...
		Private Sub Repeat_HTML_Table_Header_Footer_Demo_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
