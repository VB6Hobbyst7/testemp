Namespace EvoHtmlToPdfDemo.HTML_to_PDF.HTML_Elements_Visibility
	Partial Public Class Select_in_HTML_Elements_to_Hide_Demo
		''' <summary> 
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Select_in_HTML_Elements_to_Hide_Demo))
			...
			Me.demoLeftPanel.Size = New Size(6, 748)
			...
			Me.demoRightPanel.Size = New Size(6, 748)
			Me.demoRightPanel.TabIndex = 140
			' 
			' demoBottomPanel
			' 
			Me.demoBottomPanel.Dock = DockStyle.Bottom
			Me.demoBottomPanel.Location = New Point(0, 754)
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			Me.htmlPanel.Location = New Point(6, 277)
			Me.htmlPanel.Name = "htmlPanel"
			Me.htmlPanel.Size = New Size(598, 411)
			Me.htmlPanel.TabIndex = 146
			' 
			' label2
			' 
			...
			Me.label12.Size = New Size(236, 15)
			Me.label12.TabIndex = 42
			Me.label12.Text = "HTML String with Exclude Attributes"
			' 
			' urlPanel
			' 
			...
			Me.urlPanel.Location = New Point(6, 195)
			Me.urlPanel.Name = "urlPanel"
			Me.urlPanel.Size = New Size(598, 82)
			Me.urlPanel.TabIndex = 145
...
'			Me.viewHtmlLinkLabel.LinkClicked += New System.Windows.Forms.LinkLabelLinkClickedEventHandler(Me.viewHtmlLinkLabel_LinkClicked)
			...
			Me.convertHtmlRadioButton.Size = New Size(235, 20)
			Me.convertHtmlRadioButton.TabIndex = 69
			Me.convertHtmlRadioButton.TabStop = True
			Me.convertHtmlRadioButton.Text = "Convert HTML with Exclude Attributes"
...
'			Me.convertUrlRadioButton.CheckedChanged += New System.EventHandler(Me.convertUrlRadioButton_CheckedChanged)
			...
			Me.descriptionPanel.TabIndex = 143
			' 
			' descriptionLabel
			' 
			...
			Me.titleLabel.Size = New Size(409, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Select in HTML the Elements to Hide in Generated PDF"
			' 
			...
			Me.Name = "Select_in_HTML_Elements_to_Hide_Demo"
			Me.Size = New Size(610, 760)
'			Me.Load += New System.EventHandler(Me.Select_in_HTML_Elements_to_Hide_Demo_Load)
