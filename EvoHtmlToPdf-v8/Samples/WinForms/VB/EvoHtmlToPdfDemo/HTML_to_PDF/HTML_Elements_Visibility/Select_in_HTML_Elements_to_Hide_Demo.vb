...
Namespace EvoHtmlToPdfDemo.HTML_to_PDF.HTML_Elements_Visibility
	Partial Public Class Select_in_HTML_Elements_to_Hide_Demo
		...
		Private Sub convertToPdfButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles convertToPdfButton.Click
			...
			Dim outPdfFile As String = "DemoAppFiles\Output\HTML_to_PDF\Select_in_HTML_Elements_to_Hide.pdf"
			Try
		...
		Private Sub Select_in_HTML_Elements_to_Hide_Demo_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
