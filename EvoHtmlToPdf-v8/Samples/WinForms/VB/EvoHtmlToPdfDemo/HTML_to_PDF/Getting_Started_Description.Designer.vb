Namespace EvoHtmlToPdfDemo.HTML_to_PDF
	Partial Public Class Getting_Started_Description
		...
		Private Sub InitializeComponent()
			...
			Me.descriptionTopPanel.TabIndex = 1
			' 
			' descriptionPanel
			' 
			...
			Me.descriptionRightPanel.Size = New Size(6, 738)
			Me.descriptionRightPanel.TabIndex = 4
			' 
			...
			Me.descriptionLeftPanel.Size = New Size(6, 738)
			Me.descriptionLeftPanel.TabIndex = 5
			' 
			...
			Me.descriptionSeparatorPanel.TabIndex = 7
			' 
			' titleLabel
			' 
			...
			Me.descriptionTitlePanel.TabIndex = 6
			' 
			...
			Me.Name = "Getting_Started_Description"
			Me.Size = New Size(610, 650)
'			Me.Load += New System.EventHandler(Me.Getting_Started_Description_Load)
