Namespace EvoHtmlToPdfDemo.HTML_to_PDF.PDF_Pages_Background
	Partial Public Class Add_Elements_Over_Main_Content_Demo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(Add_Elements_Over_Main_Content_Demo))
			...
			Me.addStampCheckBox = New CheckBox()
			...
			Me.demoBottomPanel.TabIndex = 88
			' 
			' demoTopPanel
			' 
			...
			Me.convertButtonPanel.TabIndex = 115
			' 
			' convertToPdfButton
			' 
...
'			Me.convertToPdfButton.Click += New System.EventHandler(Me.convertToPdfButton_Click)
			...
			' settingsPanel
			' 
			Me.settingsPanel.Controls.Add(Me.addStampCheckBox)
			Me.settingsPanel.Dock = DockStyle.Top
			Me.settingsPanel.Location = New Point(6, 416)
			Me.settingsPanel.Name = "settingsPanel"
			Me.settingsPanel.Size = New Size(598, 53)
			Me.settingsPanel.TabIndex = 114
			' 
			' addStampCheckBox
			' 
			Me.addStampCheckBox.AutoSize = True
			Me.addStampCheckBox.Checked = True
			Me.addStampCheckBox.CheckState = CheckState.Checked
			Me.addStampCheckBox.Location = New Point(6, 16)
			Me.addStampCheckBox.Name = "addStampCheckBox"
			Me.addStampCheckBox.Size = New Size(93, 21)
			Me.addStampCheckBox.TabIndex = 0
			Me.addStampCheckBox.Text = "Add Stamp"
			Me.addStampCheckBox.UseVisualStyleBackColor = True
			' 
			' htmlStringPanel
			' 
			...
			Me.htmlStringPanel.TabIndex = 113
			...
			Me.selectHtmlToConvertPanel.TabIndex = 111
			' 
			...
			Me.descriptionPanel.TabIndex = 110
			' 
			' descriptionLabel
			' 
			...
			Me.titleLabel.Size = New Size(324, 17)
			Me.titleLabel.TabIndex = 1
			Me.titleLabel.Text = "Add Elements Over PDF Page Main Content"
			' 
			...
			Me.Name = "Add_Elements_Over_Main_Content_Demo"
		...
		Private addStampCheckBox As CheckBox
		...
		Private convertHtmlRadioButton As RadioButton
		Private convertUrlRadioButton As RadioButton
