...
namespace EvoHtmlToPdfDemo.Controllers.PDF_Creator.PDF_Security
{
    public class PDF_Creator_PDF_Permissions_and_PasswordController : Controller
    {
        ...
        public ActionResult CreatePdf(FormCollection collection)
        {
            ...
            pdfDocument.Security.CanPrint = collection["printEnabledCheckBox"] != null;
            pdfDocument.Security.CanPrintHighResolution = collection["highResolutionPrintEnabledCheckBox"] != null;
            pdfDocument.Security.CanCopyContent = collection["copyContentEnabledCheckBox"] != null;
            pdfDocument.Security.CanCopyAccessibilityContent = collection["copyAccessibilityContentEnabledCheckBox"] != null;
            pdfDocument.Security.CanEditContent = collection["editContentEnabledCheckBox"] != null;
            pdfDocument.Security.CanEditAnnotations = collection["editAnnotationsEnabledCheckBox"] != null;
            pdfDocument.Security.CanFillFormFields = collection["fillFormFieldsEnabledCheckBox"] != null;
