...
namespace EvoHtmlToPdfDemo.Controllers.PDF_Creator.PDF_Viewer_Preferences
{
    public class PDF_Creator_Set_Viewer_PreferencesController : Controller
    {
        ...
        public ActionResult CreatePdf(FormCollection collection)
        {
            ...
            pdfDocument.ViewerPreferences.HideMenuBar = collection["hideMenuBarCheckBox"] != null;
            // Hide the viewer toolbar
            pdfDocument.ViewerPreferences.HideToolbar = collection["hideToolbarCheckBox"] != null;
            // Hide scroll bars and navigation controls
            pdfDocument.ViewerPreferences.HideWindowUI = collection["hideWindowUICheckBox"] != null;

            // Display the document title in viewer title bar
            pdfDocument.ViewerPreferences.DisplayDocTitle = collection["displayDocTitleCheckBox"] != null;
