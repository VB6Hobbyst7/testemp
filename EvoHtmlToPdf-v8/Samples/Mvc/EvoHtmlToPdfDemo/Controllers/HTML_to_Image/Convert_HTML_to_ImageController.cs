...
namespace EvoHtmlToPdfDemo.Controllers.HTML_to_PDF.HTML_to_Image
{
    public class Convert_HTML_to_ImageController : Controller
    {
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult ConvertHtmlToImage(FormCollection collection)
        {
            ...
            htmlToImageConverter.TransparentBackground = SelectedImageFormat(collection["imageFormatComboBox"]) == System.Drawing.Imaging.ImageFormat.Png ? collection["transparentBackgroundCheckBox"] != null : false;
            ...
            string imageFormatName = collection["imageFormatComboBox"].ToLower();
