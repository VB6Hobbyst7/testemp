...
namespace EvoHtmlToPdfDemo.Controllers.HTML_to_PDF.PDF_Viewer_Preferences
{
    public class Set_Viewer_PreferencesController : Controller
    {
        ...
        public ActionResult ConvertHtmlToPdf(FormCollection collection)
        {
            ...
            htmlToPdfConverter.PdfViewerPreferences.HideMenuBar = collection["hideMenuBarCheckBox"] != null;
            // Hide the viewer toolbar
            htmlToPdfConverter.PdfViewerPreferences.HideToolbar = collection["hideToolbarCheckBox"] != null;
            // Hide scroll bars and navigation controls
            htmlToPdfConverter.PdfViewerPreferences.HideWindowUI = collection["hideWindowUICheckBox"] != null;

            // Display the document title in viewer title bar
            htmlToPdfConverter.PdfViewerPreferences.DisplayDocTitle = collection["displayDocTitleCheckBox"] != null;
