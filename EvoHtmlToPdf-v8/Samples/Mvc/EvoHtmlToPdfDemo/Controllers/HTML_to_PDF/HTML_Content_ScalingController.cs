...
namespace EvoHtmlToPdfDemo.Controllers
{
    public class HTML_Content_ScalingController : Controller
    {
        ...
        public ActionResult ConvertHtmlToPdf(FormCollection collection)
        {
            ...
            htmlToPdfConverter.ClipHtmlView = collection["clipContentCheckBox"] != null;
            ...
            htmlToPdfConverter.PdfDocumentOptions.FitWidth = collection["fitWidthCheckBox"] != null;
            ...
            htmlToPdfConverter.PdfDocumentOptions.StretchToFit = collection["stretchCheckBox"] != null;
            ...
            htmlToPdfConverter.PdfDocumentOptions.AutoSizePdfPage = collection["autoSizeCheckBox"] != null;
            ...
            htmlToPdfConverter.PdfDocumentOptions.FitHeight = collection["fitHeightCheckBox"] != null;
            ...
            htmlToPdfConverter.PdfDocumentOptions.SinglePage = collection["singlePageCheckBox"] != null;
