<%@ Page Title="PDF Creator - Automatically Resize the Header an Footer" Language="vb"
	MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Header_Footer_Auto_Resize.aspx.vb"
				...
				<table style="width: 100%; height: 100%">
					<tr>
						<td style="font-size: 14px; font-weight: bold; height: 20px; padding-bottom: 15px;
							padding-top: 5px">
							Automatically Resize the Header an Footer
						</td>
					</tr>
					<tr>
						<td style="width: 100%;">
