...
Namespace EvoHtmlToPdfDemo.PDF_Creator
	Partial Public Class HTML_to_PDF_Elements
		...
		Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
			If Not IsPostBack Then
				sampleCodeLiteral.Text = System.IO.File.ReadAllText(Server.MapPath("~/DemoAppFiles/Input/Code_Samples/VbNet/AspNet/PDF_Creator/HTML_to_PDF_Elements.html"))
