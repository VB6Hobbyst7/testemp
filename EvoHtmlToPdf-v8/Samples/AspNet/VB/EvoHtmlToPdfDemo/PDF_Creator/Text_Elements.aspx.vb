...
Namespace EvoHtmlToPdfDemo.PDF_Creator
	Partial Public Class Text_Elements
		...
		Protected Sub createPdfButton_Click(ByVal sender As Object, ByVal e As EventArgs)
			...
			Try
				...
				Dim localTrueTypeFont As PdfFont = pdfDocument.AddFont(Server.MapPath("~/DemoAppFiles/Input/Fonts/TrueType.ttf"))
				...
				Dim localOpenTypeTrueTypeFont As PdfFont = pdfDocument.AddFont(Server.MapPath("~/DemoAppFiles/Input/Fonts/OpenTypeTrueType.otf"))
				...
				Dim localOpenTypePostScriptFont As PdfFont = pdfDocument.AddFont(Server.MapPath("~/DemoAppFiles/Input/Fonts/OpenTypePostScript.otf"))
				...
				Dim text As String = System.IO.File.ReadAllText(Server.MapPath("~/DemoAppFiles/Input/Text_Files/Text_File.txt"))
				...
				' Add the text element
				Dim multiPageText As String = System.IO.File.ReadAllText(Server.MapPath("~/DemoAppFiles/Input/Text_Files/Large_Text_File.txt"))
		...
		Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
			If Not IsPostBack Then
				sampleCodeLiteral.Text = System.IO.File.ReadAllText(Server.MapPath("~/DemoAppFiles/Input/Code_Samples/VbNet/AspNet/PDF_Creator/Text_Elements.html"))
