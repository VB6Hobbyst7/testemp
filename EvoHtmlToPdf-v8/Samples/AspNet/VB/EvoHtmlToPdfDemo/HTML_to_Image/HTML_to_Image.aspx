<%@ Page Title="Convert HTML to Raster Image" Language="vb" MasterPageFile="~/MasterPage.Master"
	AutoEventWireup="true" CodeBehind="HTML_to_Image.aspx.vb" Inherits="EvoHtmlToPdfDemo.HTML_to_Image.HTML_to_Image" %>
																			...
																			<tr>
																				...
																				<td>
																					<asp:CheckBox ID="transparentBackgroundCheckBox" runat="server" 
																						Text="Transparent Background" Checked="False" />
																				</td>
																			</tr>
																		</table>
																	</td>
