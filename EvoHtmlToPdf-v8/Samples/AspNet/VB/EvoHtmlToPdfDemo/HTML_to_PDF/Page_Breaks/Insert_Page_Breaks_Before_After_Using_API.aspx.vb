	...
	Partial Public Class Insert_Page_Breaks_Before_After_Using_API
		...
		Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
			If Not IsPostBack Then
				...
				sampleCodeLiteral.Text = System.IO.File.ReadAllText(Server.MapPath("~/DemoAppFiles/Input/Code_Samples/VbNet/AspNet/HTML_to_PDF/Page_Breaks/Insert_Page_Breaks_in_API.html"))
