...
Namespace EvoHtmlToPdfDemo.HTML_to_PDF.Images_Quality
	Partial Public Class Images_Scaling_and_JPEG_Compression
		...
		Protected Sub convertToPdfButton_Click(ByVal sender As Object, ByVal e As EventArgs)
			...
			htmlToPdfConverter.PdfDocumentOptions.JpegCompressionLevel = Integer.Parse(jpegCompressionLevelTextBox.Text)
		...
		Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
			If Not IsPostBack Then
				sampleCodeLiteral.Text = System.IO.File.ReadAllText(Server.MapPath("~/DemoAppFiles/Input/Code_Samples/VbNet/AspNet/HTML_to_PDF/Images_Quality/Scaling_JPEG_Compression.html"))
