<%@ Page Title="Add Header and Footer In External PDF Documents" Language="vb" MasterPageFile="~/MasterPage.Master"
	AutoEventWireup="true" CodeBehind="Header_Footer_In_External_PDF.aspx.vb" Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.Headers_and_Footers.Header_Footer_In_External_PDF" %>
