<%@ Page Title="Merge Multiple HTML Pages into a Single PDF" Language="vb" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Header_Footer_on_Merged_HTML.aspx.vb" Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.Headers_and_Footers.Header_Footer_on_Merged_HTML" %>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ID="secondUrlTextBox" runat="server" Text="http://www.evopdf.com" Width="500px"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
