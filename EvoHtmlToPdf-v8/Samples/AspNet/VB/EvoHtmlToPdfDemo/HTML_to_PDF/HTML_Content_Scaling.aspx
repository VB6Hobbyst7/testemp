<%@ Page Title="Control HTML Scaling in PDF Page" Language="vb" MasterPageFile="~/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="HTML_Content_Scaling.aspx.vb" Inherits="EvoHtmlToPdfDemo.HTML_to_PDF.HTML_Content_Scaling" %>
                                                                    ...
                                                                    <td>
                                                                        <table>
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 3px"></td>
                                                                                <td>
                                                                                    <asp:TextBox ID="htmlViewerZoomTextBox" runat="server" Width="30px">100</asp:TextBox>
                                                                                </td>
