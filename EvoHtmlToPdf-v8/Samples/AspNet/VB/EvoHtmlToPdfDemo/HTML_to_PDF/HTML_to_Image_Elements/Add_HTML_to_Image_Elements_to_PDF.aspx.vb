	...
	Partial Public Class Add_HTML_to_Image_Elements_to_PDF
		...
		Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
			If Not IsPostBack Then
                sampleCodeLiteral.Text = System.IO.File.ReadAllText(Server.MapPath("~/DemoAppFiles/Input/Code_Samples/VbNet/AspNet/HTML_to_PDF/HTML_to_Image_Elements/Add_HTML_to_Image.html"))
