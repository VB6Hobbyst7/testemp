...
Namespace EvoHtmlToPdfDemo.HTML_to_PDF.URI_Links
	Partial Public Class Define_Custom_URI_Links
		...
		Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
			If Not IsPostBack Then
				...
				sampleCodeLiteral.Text = System.IO.File.ReadAllText(Server.MapPath("~/DemoAppFiles/Input/Code_Samples/VbNet/AspNet/HTML_to_PDF/URI_Links/Define_Custom_URI_Links.html"))
